...
var icelandAboutOpen = document.querySelector('#iceland-btn'),
...
tlAbout.from('#textDiscAbout', {
  x: 100,
  opacity: 0,
  duration: 2
});
tlAbout.from('#parAbout', {
  y: 200,
  opacity: 0,
  duration: 1
}, "-=2");
tlAbout.from('#bthAbout', {
  x: -200,
  opacity: 0,
  duration: 1
}, "-=2");
tlAbout.from('#iconAbout', {
  x: 400,
  opacity: 0,
  duration: 1
}, "-=2");
...
tlAbout.from('.contact__form', {
  x: 100,
  opacity: 0,
  duration: 2
});
tlAbout.from('.contact__map', {
  x: -100,
  opacity: 0,
  duration: 1
}, "-=2");
...
try {
  var _loop = function _loop() {
    ...
    anchor.addEventListener('click', function (e) {
      e.preventDefault();
      var blockID = anchor.getAttribute('name').substring(0);
...
icelandAboutOpen.addEventListener("click", function (e) {
  icelandAbout.classList.add('active');
  icelandAboutClose.classList.add('active');
  gsap.from('.iceland-hidden', {
    x: window.innerWidth,
    duration: 1.5
  });
});
icelandAboutClose.addEventListener("click", function (e) {
  gsap.to('.iceland-hidden', {
    x: window.innerWidth,
    duration: 1.5
  });
  setTimeout(function () {
...
namibiaAboutOpen.addEventListener("click", function (e) {
  namibiaAbout.classList.add('active');
  namibiaAboutClose.classList.add('active');
  gsap.from('.namibia-hidden', {
    x: window.innerWidth,
    duration: 1.5
  });
});
namibiaAboutClose.addEventListener("click", function (e) {
  gsap.to('.namibia-hidden', {
    x: window.innerWidth,
    duration: 1.5
  });
  setTimeout(function () {
...
},{"swiper":"Riml"}]},{},["QvaY"], null)
//# sourceMappingURL=js.380b70ee.js.map