...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"libs/gsap/ScrollTrigger.min.js":[function(require,module,exports) {
var define;
      ...
      Se.previous = function () {
        ...
        if (!at && Se.enabled || t) if (ie && e && vt) mb(ScrollTrigger, "scrollEnd", Eb);else {
          ...
          for (var r, n, i, o, a, s, l, c, u, f, d = Te(), p = ke(), g = fe ? fe.duration() : Ga(be, ge), h = 0, b = 0, v = _.end, m = _.endTrigger || ne, y = _.start || (0 !== _.start && ne ? ie ? "0 0" : "0 100%" : 0), x = Se.pinnedContainer = _.pinnedContainer && I(_.pinnedContainer), w = ne && Math.max(0, Bt.indexOf(Se)) || 0, S = w; S--;) {
            (s = Bt[S]).end || s.refresh(0, 1) || (at = 1), !(l = s.pin) || l !== ne && l !== ie || s.isReverted || ((f = f || []).unshift(s), s.revert(!0, !0)), s !== Bt[S] && (w--, S--);
          }

          for (Ja(y) && (y = y(Se)), M = $b(y, ne, d, ge, Me(), C, B, Se, p, we, me, g, fe) || (ie ? -.001 : 0), Ja(v) && (v = v(Se)), Ia(v) && !v.indexOf("+=") && (~v.indexOf(" ") ? v = (Ia(y) ? y.split(" ")[0] : "") + v : (h = sb(v.substr(2), d), v = Ia(y) ? y : M + h, m = ne)), A = Math.max(M, $b(v || (m ? "100% 0" : g), m, d, ge, Me() + h, O, D, Se, p, we, me, g, fe)) || -.001, z = A - M || (M -= .01) && .001, h = 0, S = w; S--;) {
            (l = (s = Bt[S]).pin) && s.start - s._pinPush < M && !fe && 0 < s.end && (r = s.end - s.start, l !== ne && l !== x || Ka(y) || (h += r * (1 - s.progress)), l === ie && (b += r));
          }
          ...
          if (M += h, A += h, Se._pinPush = b, C && h && ((r = {})[ge.a] = "+=" + h, x && (r[ge.p] = "-=" + Me()), Ge.set([C, O], r)), ie) r = cb(ie), o = ge === je, i = Me(), H = parseFloat(N(ge.a)) + b, !g && 1 < A && ((ve ? rt : be).style["overflow-" + ge.a] = "scroll"), Ub(ie, R, r), Y = Xb(ie), n = Ct(ie, !0), c = me && J(be, o ? Je : je)(), oe && ((W = [oe + ge.os2, z + b + At]).t = R, (S = oe === Et ? gb(ie, ge) + z + b : 0) && W.push(ge.d, S + At), Lt(W), me && Me(U)), me && ((a = {
            ...
            return i.t = e.t, i;
          }(L, a, ue), pt && Me(0)), T ? (u = T._initted, ut(1), T.render(T.duration(), !0, !0), F = N(ge.a) - H + z + b, z !== F && me && X.splice(X.length - 2, 2), T.render(0, !0, !0), u || T.invalidate(), ut(0)) : F = z;else if (ne && Me() && !fe) for (n = ne.parentNode; n && n !== rt;) {
            n._pinOffset && (M -= n._pinOffset, A -= n._pinOffset), n = n.parentNode;
          }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","libs/gsap/ScrollTrigger.min.js"], null)
//# sourceMappingURL=/ScrollTrigger.min.3ced7572.js.map